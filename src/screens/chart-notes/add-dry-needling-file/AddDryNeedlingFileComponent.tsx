...
import {IDryNeedlingForm} from "../../../shared/models/chart-notes.model";
...
const AddDryNeedlingFormInitialValues: IDryNeedlingForm = {
...
const AddDryNeedlingFileComponent = (props: AddDryNeedlingFileComponentProps) => {
    ...
    const [addDryNeedlingFormInitialValues] = useState<IDryNeedlingForm>(_.cloneDeep(AddDryNeedlingFormInitialValues));
                                        ...
                                        <>
                                            {
                                                (!values.attachment) && <>
                                                    <FilePickerComponent maxFileCount={1}
                                                                         ...
                                                                         acceptedFilesText={"Only PDF files are allowed"}
