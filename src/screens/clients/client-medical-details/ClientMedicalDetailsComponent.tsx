    ...
    return (
        <div className={'client-medical-details-component'}>
            ...
            <CardComponent title={'Medical History'}>
                {
                    clientMedicalDetails?.medical_history?.questions?.length > 0 && clientMedicalDetails?.medical_history?.questions?.map((question, index) => {
                ...
                {
                    clientMedicalDetails?.medical_history?.questions?.length > 0 && <span>, </span>
                }
            ...
            <CardComponent title={'Surgical History'}>
                ...
                {
                    clientMedicalDetails?.surgical_history?.questions?.length > 0 && <span>, </span>
                }
